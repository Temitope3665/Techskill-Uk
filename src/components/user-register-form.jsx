...
const UserRegistrationForm = () => {
  ...
  <AlertDialogContent>
    <AlertDialogHeader>
      <AlertDialogTitle className="text-black font-gilroyBold">Choose Payment Plan</AlertDialogTitle>
      <AlertDialogDescription>
      You have the option of paying now for a discount or paying in installments.
      </AlertDialogDescription>
    </AlertDialogHeader>
    <div>
    <Select onValueChange={(value) => setPaymentPlan(value)} defaultValue='£250'>
    ...
    <Link to='https://buy.stripe.com/test_00g9DJ6374jPbzG9AA'>
      <Button type="submit" size="sm" className="w-full">Make payment</Button>
    </Link>
  </AlertDialogContent>
</AlertDialog>
