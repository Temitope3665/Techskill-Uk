  ...
  return (
    <div className="">
      <div className="px-6 md:px-12 pb-12">
        <div className="md:flex justify-between w-full items-center mt-4 md:mt-16">
          <div className="md:w-[45%] text-center md:text-left">
            <h1 className="text-[30px] md:text-[60px] font-gilroyBold">
              Your Tech Career Accelerator
            </h1>
            <div className="h-1 w-[30%] bg-yellow -mt-3 hidden md:flex" />
            <p className="md:mt-6 md:w-[80%] text-base">
      ...
      <div className="bg-primary px-6 md:px-12 md:flex justify-between items-center pt-16">
        <div className="md:w-[50%]">
          <img
            src={AccelerateCareer}
            alt="team work dream career"
            className="md:h-[650px] pb-12"
          />
        </div>
        <div className="md:w-[50%] md:px-12 relative md:h-[650px] md:pt-14">
          <h1 className="text-[24px] md:text-[50px] font-gilroyBold  md:leading-[48px] text-center md:text-left">
            Let’s accelerate you to your dream career
          </h1>
          <div className="md:w-[90%] mt-3 md:mt-8 text-center md:text-left">
            ...
            <p className="mt-4 text-[14px] md:text-[18px]">
          ...
          <img
            src={Star2}
            alt="star"
            className="absolute bottom-0 w-[100px] md:w-[400px] right-0"
          />
        </div>
      </div>

      <div className="bg-secondary pt-12 md:pt-24 pb-32 md:pb-48 relative">
        <div className="grid md:grid-cols-3 px-4 md:px-12 md:gap-y-0 gap-x-12 gap-y-8">
          {us.map((wh) => (
            <div
            ...
            >
              ...
              />
              <h3 className="font-gilroyBold text-[18px] md:text-[24px] mt-14">
                {wh.title}
              </h3>
          ...
          <img
            src={Accelerate}
            alt="accelerate"
            className="w-[200px] md:w-[400px] absolute right-0 bottom-0"
          />
        </div>
      </div>

      <div className="bg-primary px-6 md:px-12 md:flex justify-between items-center py-6 md:py-16 relative">
        <div className="md:w-[50%] md:px-12 relative pt-14 text-center md:text-left">
          <h1 className="text-[30px] md:text-[50px] font-gilroyBold leading-[48px]">
            What we stand for
          </h1>
          <div className="md:w-[90%] mt-2 md:mt-8">
      ...
      <div className="text-center py-12">
        <div className="md:w-[50%] mx-auto">
          <h1 className="font-gilroyBold text-[30px] md:text-[50px] md:mt-3">
            Join our community
          </h1>
          <p className="text-grey md:w-[60%] mx-auto md:text-base text-sm px-12 md:px-0">
            Let’s help accelerate your tech career and get you ready for the
            tech world
          </p>
        </div>

        <div className="border border-grey p-8 rounded-xl md:w-[45vw] mx-6 md:mx-auto mt-8">
      ...
      <div className="py-10 md:py-20 bg-primary w-full px-6 md:px-12">
        <h1 className="font-gilroyBold text-[30px] md:text-[50px] md:mt-3 text-center">
          Meet Our Experts
        </h1>

        <div className="w-full grid grid-cols-2 md:grid-cols-5 gap-4 mt-2 justify-items-center text-center">
          {experts.map((expert) => (
            <div className="text-center mt-8" key={expert.name}>
              <div className='rounded-full w-[120px] h-[120px] mx-auto'>
                <img src={expert.image} alt={expert.name} />
              </div>
              <p className='text-sm font-gilroyMd mt-2'>{expert.name}</p>
