  ...
  useEffect(() => {
    ...
    const getCourseById = async () => {
      try {
        ...
        setCourse({
          ...currentCourse?.fields,
          courseId: currentCourse?.sys?.id,
        });
        setIsLoading(false);
      } catch (error) {
        toast({
        ...
        <div className="bg-primary -mt-4">
          <div className="lg:flex justify-between items-center px-6 lg:px-12 pt-12">
            <div className="lg:w-[55%] text-center lg:text-left">
              ...
              <h1 className="font-gilroyBold text-[24px] lg:text-[45px]">{course?.title}</h1>
              <h3 className="mt-2 lg:w-[90%]">{course?.description}</h3>
            ...
            <div className="lg:w-[40%] mt-6 lg:mt-0">
              <img src={course?.image?.fields?.file?.url} alt={`learn-${course?.title.toLowerCase().replace(/ /g, '-')}`} />
            </div>
          </div>

          <div className="grid lg:grid-cols-2 bg-secondary mt-6 lg:mt-24 px-6 lg:px-24 py-12 lg:py-16 relative" data-aos="fade-up" data-aos-duration="1000">
            <div className="border border-yellow rounded-lg lg:w-[55%]">
              <h3 className="border-b-[0.5px] border-yellow py-4 font-gilroyMd text-yellow text-center">{course?.title}</h3>
                ...
                {course?.courseSection?.section?.map((outline) => (
                  <li key={outline} className="flex items-center py-4">
                    <Circle
                      ...
                      className="mr-2"
                    />{' '}
                    <p className={`${outline === 'About this course' ? 'text-white font-gilroyBold' : 'text-grey font-gilroyMd'}`}>{outline}</p>
                  </li>
                ))}
                <ul></ul>
              </div>
            ...
            <div className="text-center lg:text-left">
              <h1 className="font-gilroyBold text-[24px] mt-8 lg:mt-0 lg:text-[35px]">About this course</h1>
              <p className="py-4">{course?.aboutCourse}</p>
              ...
              <div className="flex mt-20 justify-between lg:w-[85%]">
                ...
                <div className="text-center">
                  ...
                  <p className="text-grey text-sm font-gilroyMd py-3">10/10 Student review</p>
                </div>
                <div className="text-center">
                  <p className="text-yellow text-[30px]">10</p>
                  <p className="text-grey text-sm font-gilroyMd">No. of students per class</p>
                </div>
              </div>
            </div>
          </div>

          <div className="grid lg:grid-cols-2 bg-primary mt-6 lg:mt-16 px-6 lg:px-24 relative" data-aos="fade-up" data-aos-duration="1000">
            <div className="border border-yellow rounded-lg lg:w-[55%]">
              <h3 className="border-b-[0.5px] border-yellow py-4 font-gilroyMd text-yellow text-center">{course?.title}</h3>
              <div className="py-4 px-8">
                {course?.courseSection?.section?.map((outline) => (
                  <li key={outline} className="flex items-center py-4">
                    <Circle
                      ...
                      className="mr-2"
                    />{' '}
                    <p className={`${outline === 'Learning objectives' ? 'text-white font-gilroyBold' : 'text-grey font-gilroyMd'}`}>{outline}</p>
                  </li>
                ))}
                <ul></ul>
              </div>
            ...
            <div className="text-center lg:text-left">
              <h1 className="font-gilroyBold text-[24px] mt-8 lg:mt-0 lg:text-[35px]">Learning objectives</h1>
              <p className="py-2">Upon completing this course, you will learn to:</p>
          ...
          <div className="grid lg:grid-cols-2 bg-secondary mt-6 lg:mt-16 px-6 lg:px-24 py-12 items-start" data-aos="fade-up" data-aos-duration="1000">
            <div className="border border-yellow rounded-lg lg:w-[55%]">
              <h3 className="border-b-[0.5px] border-yellow py-4 font-gilroyMd text-yellow text-center">{course?.title}</h3>
              <div className="py-4 px-8">
                {course?.courseSection?.section?.map((outline) => (
                  <li key={outline} className="flex items-center py-4">
                    <Circle
                      ...
                      className="mr-2"
                    />{' '}
                    <p className={`${outline === 'Course schedules' ? 'text-white font-gilroyBold' : 'text-grey font-gilroyMd'}`}>{outline}</p>
                  </li>
                ))}
                <ul></ul>
              </div>
            ...
            <div className="text-center lg:text-left">
              <h1 className="font-gilroyBold text-[24px] mt-8 lg:mt-0 lg:text-[35px]">Course schedules</h1>
          ...
          <div className="lg:flex justify-between bg-secondary mt-6 lg:mt-16 px-6 lg:px-20 py-8 items-start" data-aos="fade-up" data-aos-duration="1000">
            <div className="w-[100%]">
              <h1 className="font-gilroyBold text-[24px] mt-8 lg:mt-0 lg:text-[35px]">Pricing</h1>
              <p className="font-gilroyMd lg:w-[50%] text-sm lg:text-base">
                With our flexible pricing plans, we’ve made it easier for you to pay for the course. Use the options below to pay for any of our services.
              </p>
          ...
          paying for our training"
                  title="Training Fee Only"
                  price={course?.upfrontPrice}
                  href={`${process.env.REACT_STRIPES_PREMIUM_PACKAGE_TRAINING_ONLY}`}
                />
                <Pricing
                  description="Get the best deal by paying for our mentorship program"
                  title="Mentorship"
                  price={'150'}
                  href={`${process.env.REACT_STRIPES_GLOBAL_TALENT_CONSULTATION}`}
                />
                <Pricing
                  description="Get the best deal by paying for our practical program"
                  title="Practical"
                  price={'250'}
                  href={`${process.env.REACT_STRIPES_GLOBAL_TALENT_CONSULTATION}`}
                />
                <Pricing
                  description="Get the best deal by paying for our career support"
          ...
          <div className=" bg-primary mt-6 lg:mt-10 px-6 lg:px-20 py-3 items-start" data-aos="fade-up" data-aos-duration="1000">
            <h1 className="font-gilroyBold text-[24px] mt-8 lg:mt-0 lg:text-[35px]">Tools you’ll learn from</h1>
