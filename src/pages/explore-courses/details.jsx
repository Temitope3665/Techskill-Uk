        ...
        <div className="bg-primary -mt-4">
          <div className="lg:flex justify-between items-center px-6 lg:px-12 pt-12">
            <div className="lg:w-[55%] text-center lg:text-left">
              ...
              <h3 className="mt-2 lg:w-[70%]">{course?.description}</h3>
            ...
            /> */}
              ...
              <Link
                to={`/explore-courses/user-registration/${course?.courseId}`}
              >
          ...
          <div
            className="grid lg:grid-cols-2 bg-secondary mt-6 lg:mt-24 px-6 lg:px-24 py-12 lg:py-16 relative"
            data-aos="fade-up"
              ...
              <div className="py-4 px-8">
                {course?.courseSection?.section?.map((outline) => (
                  <li key={outline} className="flex items-center py-4">
                    <Circle
                      fill={
                        outline === 'About this course' ? '#fff' : '#818992'
                      }
                      color={
                        outline === 'About this course' ? '#fff' : '#818992'
                      }
          ...
          <div
            className="grid lg:grid-cols-2 bg-primary mt-6 lg:mt-16 px-6 lg:px-24 relative"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            <div className="border border-yellow rounded-lg lg:w-[55%]">
              ...
              <div className="py-4 px-8">
                {course?.courseSection?.section?.map((outline) => (
                  <li key={outline} className="flex items-center py-4">
                    <Circle
                      fill={
                        outline === 'Learning objectives' ? '#fff' : '#818992'
                      }
                      color={
                        outline === 'Learning objectives' ? '#fff' : '#818992'
                      }
          ...
          <div
            className="grid lg:grid-cols-2 bg-secondary mt-6 lg:mt-16 px-6 lg:px-24 py-12 items-start"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            <div className="border border-yellow rounded-lg lg:w-[55%]">
                ...
                {course?.courseSection?.section?.map((outline) => (
                  <li key={outline} className="flex items-center py-4">
                    <Circle
                      ...
                      color={
                        outline === 'Course schedules' ? '#fff' : '#818992'
                      }
                      size={9}
                      className="mr-2"
                    />{' '}
          ...
          <div
            className="grid lg:grid-cols-1 bg-primary mt-6 lg:mt-16 px-6 lg:px-24 py-8 items-start"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            <div className="text-center lg:text-left">
              ...
              <p className="font-gilroyMd">
                Our {course?.benefits?.objectives?.length} benefits will give
                you the confidence to ace a real one
              </p>
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 mt-10">
                {course?.benefits?.objectives?.map((benefit) => (
                  <div
                    key={benefit.title}
                    className="text-sm border-white border-[0.5px] rounded-lg p-4"
                  >
                    <img src={BenefitsArch} alt="benefits point" width={20} />

                    <div className="mt-24">
                      <p className="font-gilroyBold text-[18px]">
                        {benefit.title}
                      </p>
          ...
          <div
            className="lg:flex justify-between bg-secondary mt-6 lg:mt-16 px-6 lg:px-20 py-8 items-start"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            <div className="w-[100%]">
              ...
              <p className="font-gilroyMd lg:w-[50%] text-sm lg:text-base">
                With our flexible pricing plans, we’ve made it easier for you to
                pay for the course. Use the options below to pay for any of our
                services.
              </p>
          ...
          <div
            className=" bg-primary mt-6 lg:mt-10 px-6 lg:px-20 py-3 items-start"
            data-aos="fade-up"
            data-aos-duration="1000"
          >
            <h1 className="font-gilroyBold text-[24px] mt-8 lg:mt-0 lg:text-[35px]">
