    ...
    <div className="py-8">
      ...
      <div className="lg:flex justify-between w-full items-center mt-4 lg:mt-16 px-6 lg:px-12">
        <div className="lg:w-[45%] text-center lg:text-left">
          <h1 className="text-[30px] lg:text-[60px] font-gilroyBold">Join the Techskill UK community</h1>
          <div className="h-1 w-[30%] bg-yellow -mt-3 hidden lg:flex" />
          <p className="lg:mt-6 lg:w-[80%] text-base text-grey">
            Ready to take a step in your tech career but unsure where to begin? Join our community today! Get personalized guidance, choose the perfect tech
            program, and enroll confidently.
          </p>
      ...
      <div className="bg-primary px-6 lg:px-12 lg:flex justify-between items-center py-6 lg:py-16">
        <div className="lg:w-[50%] text-center lg:text-left">
          <h1 className="text-[30px] lg:text-[50px] font-gilroyBold leading-[48px] lg:-mt-8">Learn from a diverse group of peers</h1>
          <div className="lg:w-[90%] mt-2 lg:mt-8">
            <p className="text-[18px] text-grey">
              Learn from a diverse group of peers, gaining valuable insights from different backgrounds and experiences to enhance your learning journey in the
        ...
        <div className="lg:w-[40%] mt-8 lg:mt-0">
          <img src={Learning} alt="learning from diverse groups" className="pb-12" />
        </div>
      </div>

      <div className="lg:py-12 px-6 lg:px-12">
        <h1 className="text-[25px] lg:text-[50px] font-gilroyBold text-center lg:text-left">Upcoming Events</h1>
        ...
        <div className="lg:flex justify-between items-center py-12 lg:px-16">
          <div className="lg:w-[50%]">
            <img src={e?.fields?.image?.fields?.file?.url} alt="twitter space" className="h-[450px]" />
          </div>

          <div className="lg:w-[55%] mt-8 lg:mt-0">
            <h2 className="text-[24px] lg:text-[40px] text-grey font-gilroyBold">
              Join us on X Space <span className="text-yellow">@techskilluk</span>
            </h2>
            <div className="border border-grey rounded-xl lg:w-[90%] p-6 mt-2">
              <p>Topic:</p>
              <h2 className="text-[18px] lg:text-[30px] font-gilroyHeavy py-4 lg:py-0">{e?.fields?.topic}</h2>
              ...
              <div className="md:my-6 md:flex space-y-3 md:space-y-0 block items-center">
                <div className="border border-grey flex items-center rounded-[24px] p-2">
                  ...
                  <p className="px-2 md:text-sm text-[12px]">{formatDatee(e?.fields?.timeAndDate)}</p>
                </div>
                ...
                <div className="border border-grey flex items-center rounded-[24px] p-2">
                  ...
                  <p className="px-2 md:text-sm text-[12px]">
                    {e?.fields?.timewat} {e?.fields?.timeukTime && `| ${e?.fields?.timeukTime}`}
                  </p>
                </div>
              </div>

              <Link to={e?.fields?.url} target="_blank">
