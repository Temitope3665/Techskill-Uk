    ...
    <div>
      ...
      <main className="grid items-center justify-between md:grid-cols-2 px-6 md:px-12 md:py-6">
        <div className="md:pl-8 mt-8 text-center md:text-left capitalize">
          <h1 className="font-gilroyBold text-[35px] leading-[1.3] md:text-[55px]">
            <span className="text-yellow">{banner.title.split(' ')[0] || 'Accelerate'}</span> your career today with Digital Transformation
          </h1>
        ...
        <img src={banner.image || TransformDigitally} alt="transforming digitally" className="md:h-[80vh] -ml-6 md:ml-0" />
      </main>
      <section className="py-16 md:py-24 bg-primary mt-6 md:mt-12 px-6 md:px-40">
        <div className="text-center w-full" ddata-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
          <h1 className="text-[#EFF5FB] text-[35px] md:text-[60px] font-gilroyBold">What defines us</h1>
          <p className="text-base text-grey font-gilroyMd -mt-2 px-12 md:px-0">See who we are and unlock your new potential with us</p>
        </div>
        ...
        <div className="border-[0.5px] border-[#818992] px-6 py-6 md:py-12 rounded-[22px] md:rounded-[32px] bg-secondary mt-12 md:mt-40 flex justify-between relative">
          <div className="px-2 md:px-12 md:w-1/2" data-aos="fade-left" data-aos-duration="1000">
            <h2 className="text-yellow font-gilroyBold text-[18] md:text-[28px]">Get transformed</h2>
            <div className="text-base">
              <p className="">
                TechSkill UK Accelerate serves as the gateway connecting tech enthusiasts to the tech industry. Our fervour lies in empowering individuals with
                easily attainable, no-coding tech skills, catering to those eager to swiftly transition into the tech field.
              </p>
              <p className="text-grey mt-8">Our hands-on courses are meticulously crafted for immediate application in the tech sphere.</p>
      ...
      <section className="py-8 md:py-24 px-6 md:px-40 w-full" data-aos="fade-up" data-aos-duration="1000">
        <div className="text-center w-full">
          <h1 className="text-[#EFF5FB] text-[30px] md:text-[60px] font-gilroyBold">Explore our courses</h1>
      ...
      <section className="w-full bg-primary relative" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
        <img src={SemiCircle} alt="semi circle" className="absolute w-[250px] md:w-[400px]" />
        <div className="text-center w-full py-10 md:py-20">
          <h1 className="text-[#EFF5FB] text-[30px] md:text-[60px] font-gilroyBold">Unique Selling Points</h1>
          <p className="md:text-base text-grey font-gilroyMd text-sm md:-mt-2">Here’s why we are different and stand out</p>
        </div>
        <div className="grid md:grid-cols-4 px-4 md:px-12 pb-12 md:gap-y-0 gap-y-4 gap-x-8">
          {why.map((wh) => (
            <div className="border-grey border border-[0.5] rounded-[16px] p-4" key={wh.title}>
              <img src={wh.icon} alt="skill training icon" className="w-[40px] mt-7" />
      ...
      <section className="bg-secondary px-6 md:px-12 py-8 w-full mb-9" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1000">
        ...
        <h2 className="font-regularItalic text-[24px] md:text-[35px] text-grey">See what people say about us...</h2>

        <div className="grid md:grid-cols-3 py-8 gap-x-6 gap-y-4">
          {testimonials.map((testimonial) => (
            <Testimonial image={testimonial.image} name={testimonial.name} review={testimonial.review} position={testimonial.position} key={testimonial.name} />
          ))}
        </div>

        <div className="border border-grey p-8 rounded-xl md:w-[45vw] mx-auto mt-8">
          <h1 className="text-[#EFF5FB] text-[18px] md:text-[30px] font-gilroyBold text-center">Ready to join a cohort?</h1>
      ...
      <Dialog onOpenChange={setOpen} open={open}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle className="text-black font-gilroyBold">Choose Payment Plan</DialogTitle>
            <DialogDescription>Use the options below to pay for any of our services.</DialogDescription>
          </DialogHeader>
          <div>
            <Select onValueChange={(value) => setPaymentPlan(value)} defaultValue={paymentPlans[0].paymentLink}>
